package com.yy.springsecurity02.util;

import com.yy.springsecurity02.bean.ResourceBean;
import com.yy.springsecurity02.bean.RoleBean;
...
public class TestData {
    ...
    public UserBean queryUser(UserBean user){
        ...
        List<UserBean> userList=allUser.stream().filter(userBean -> userBean.getUsername().equals(user.getUsername())&&userBean.getPassword().equals(user.getPassword())).collect(Collectors.toList());
